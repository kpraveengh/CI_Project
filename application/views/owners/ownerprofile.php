                      ...
                      <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="id" id="id" value=" <?php  echo $user->getId(); ?>"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="dob" id="dob"  value=" <?php  echo $user->getDob(); ?>"/>
                            </div>
                        </div>
                    </div>
                           <div class="form-group">
