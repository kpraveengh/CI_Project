        ...
        <div class="container">
            <div class="row main">
                ...
                <div class="main-login main-center">
                    <?php echo form_open_multipart('owner/createproduct'); ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="dob" class="cols-sm-2 control-label">Chef_id</label>
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calender fa-lg" aria-hidden="true"></i></span>
                                <input type="number" class="form-control" name="chef_id" id="password"  placeholder="member-Id"/>
                            </div>
                        </div>
                    </div>
